...
if uploaded_file is not None:
    ...
    def generate_3d_scatter(data):
        ...
        scatter = ax.scatter(data['时间(s)', fontproperties=simhei_font], data['颈部角度(°)', fontproperties=simhei_font], data['肩部旋转角度(°)', fontproperties=simhei_font], c=data['肩部外展/内收角度(°)', fontproperties=simhei_font], cmap='viridis')
